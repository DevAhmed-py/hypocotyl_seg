...
#  convert images to YOLO format using coco annotations 
...
if __name__ == "__main__":
    base_input_path = "../YOLOv8-final/data/"
    base_output_path = "../YOLOv8-final/yolo_dataset/"
    ...
    create_yaml(
        ...
        test_path='yolo_dataset/test/'  # or None if not applicable
    )
